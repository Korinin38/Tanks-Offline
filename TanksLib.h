...
//!
//! @file    TanksLib.h
//! @brief   Áèáëèîòåêà ôóíêöèé òàíêà
//!
//!          $Version: 0.5.9$
//!          $Date: 2018-03-22 20:42:74 +0500 $
//!
//!          Áèáëèîòåêà TanksLibrary åñòü íàáîð ôóíêöèé, íåîáõîäèìûõ äëÿ ðàáîòû ïðîãðàììû
//!          Â îñíîâå ðàáîòû ñòîèò áèáëèîòåêà TXLibrary, ñîçäàííàÿ Èëü¸é Äåäèíñêèì
//!
//! @warning <b>Ýòî áåòà-âåðñèÿ. Äëÿ èñïîëüçîâàíèÿ òðåáóåòñÿ ñîãëàñîâàíèå ñ àâòîðîì áèáëèîòåêè.</b> @nn
//!
//!
//-----------------------------------------------------------------------------------------------------------------
//!
//! @defgroup Drawing   Ðèñîâàíèå
//! @defgroup Interface Èíòåðôåéñ
//! @defgroup Logic     Ëîãèêà
//}
//=================================================================================================================
...
/*!
    ...
    @brief   Îòðèñîâêà êàðòû
             Ðèñóåò êàðòó, îñíîâûâàÿñü íà ñòðóêòóðå mapMas[][]

    @param   xOfCenter X-êîîðäèíàòà öåíòðà êàðòû
    @param   yOfCenter Y-êîîðäèíàòà öåíòðà êàðòû
    @param   mapSize   Ðàçìåð êàðòû
    @param   mapDat1   Êîëè÷åñòâî ñòðîê
    @param   mapDat2   êîëè÷åñòâî ñòîëáöî
